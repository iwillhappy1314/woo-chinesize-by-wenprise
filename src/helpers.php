 ...
 * @return array|mixed
 */
function wprs_city_code_convert($wc_code = null)
{
 ...
 * @return array|mixed
 */
function wprs_get_state_cities($state_code)
{
    $city_data = wprs_get_city_data();
    $city_code = wprs_city_code_convert($state_code);
    $cites     = [];
